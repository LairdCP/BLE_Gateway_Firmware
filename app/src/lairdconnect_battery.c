...
struct battery_data *batteryGetStatus()
{
	...
	batteryStatus.batteryThresholdGood = BatteryGetThresholds(BATTERY_IDX_4);
	batteryStatus.batteryThresholdBad = BatteryGetThresholds(BATTERY_IDX_ALARM);
	batteryStatus.batteryThresholdLow = BatteryGetThresholds(BATTERY_IDX_LOW);
