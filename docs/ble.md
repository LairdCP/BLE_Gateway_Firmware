...
| Status           | 3e12f002-0a2a-324b-2685-8349747c5745 | read/notify       | Integer. A negative value - indicates system error code, 0 - Success, 1 - Busy, 2 - Unspecific error code.  Any value other than 1 can be considered Idle. Busy will always be notified. Any subsequeny commands issued before a success or error response will be ignored. |
